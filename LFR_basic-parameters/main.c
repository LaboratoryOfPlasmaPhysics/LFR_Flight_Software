...
extern float
    compressed_spectral_matrix_f0[NB_BINS_COMPRESSED_MATRIX_f0 * NB_VALUES_PER_SPECTRAL_MATRIX];
...
int main(void)
{
    ...
    // filename="/WIN/Users/chust/DD CHUST/Missions/Solar Orbiter/LFR/Prog C/tests bp
    // Paul/tests7/sm_test2_R3.dat";
    filename
        = "/home/chust/DD pc-p-chust/Missions/Solar Orbiter/LFR/Prog C/tests bp "
          "Paul/tests7/sm_test2_R3.dat";
    ...
    BP1_set(
        compressed_spectral_matrix_f0, k_coefficients_f0, NB_BINS_COMPRESSED_MATRIX_f0, LFR_BP1_f0);
