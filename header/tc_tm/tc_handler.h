...
#define CAL_SCALE_FACTOR                                                                           \
    (0.250 / 0.000654) // 191, 500 mVpp, 2 sinus waves => 500 mVpp each, amplitude = 250 mV
...
#define BYTES_FOR_2_SAMPLES                                                                        \
    3 // one need 3 bytes = 24 bits to store 3 samples of 12 bits in interleaved mode
