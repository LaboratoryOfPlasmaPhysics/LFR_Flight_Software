...
// PACKET CODES
#define TM_CODE_K_DUMP                                                         \
  0xb5600b00 // 181 (0xb5) ** 96 (0x60) ** 11 (0x0b) ** 0 (0x00)
...
#define PACKET_LENGTH_TM_LFR_SCIENCE_NORM_BP1_F0                               \
  (150 -                                                                       \
   CCSDS_TC_TM_PACKET_OFFSET) // 11 * 11     + 29 (1 spare byte in the header)
#define PACKET_LENGTH_TM_LFR_SCIENCE_NORM_BP1_F1                               \
  (172 -                                                                       \
   CCSDS_TC_TM_PACKET_OFFSET) // 13 * 11     + 29 (1 spare byte in the header)
