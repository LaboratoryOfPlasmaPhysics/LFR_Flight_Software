...
/* Counters that are collected.  */
    ...
    #define GCOV_LAST_VALUE_COUNTER                                                                \
        4 /* The last of counters used for value                                                   \
             profiling.  */
...
/* A list of human readable names of the counters */
    #define GCOV_COUNTER_NAMES                                                                     \
        {                                                                                          \
            "arcs", "interval", "pow2", "single", "delta"                                          \
        }

/* Names of merge functions for counters.  */
    #define GCOV_MERGE_FUNCTIONS                                                                   \
        {                                                                                          \
            "__gcov_merge_add", "__gcov_merge_add", "__gcov_merge_add", "__gcov_merge_single",     \
                "__gcov_merge_delta"                                                               \
        }
...
GCOV_LINKAGE void gcov_write_summary(
    gcov_unsigned_t /*tag*/, const struct gcov_summary*) ATTRIBUTE_HIDDEN;
